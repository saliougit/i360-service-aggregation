...
/**
 * Classe représentant une requête d'opération (prélèvement ou virement) Orange Money
 */
public class OMOperationRequest {
    ...
    // Constructeurs
    public OMOperationRequest() {
    }
    
    public OMOperationRequest(String destinatairePaye, String montant, String envoyeurPayeur, String commission) {
